package com.basic.common.base.pageImpl;

import java.util.Collections;
import java.util.List;

import com.basic.common.base.page.IGenericPage;

/**
 * 支持泛型的分页数据对象的默认实现类
 */
@SuppressWarnings("unchecked")
public class GenericDefaultPageImpl<T> implements IGenericPage<T> {
	 ...
	 *            数据总个数
	 */
	public GenericDefaultPageImpl(int pageNo, int pageSize, List<T> elements,
			int totalCount) {
		this.pageNo = pageNo;
		this.pageSize = pageSize;
		this.elements = elements;
	...
	public static final GenericDefaultPageImpl EMPTY_PAGE = new GenericDefaultPageImpl(
			0, 0, Collections.emptyList(), 0);

	/**
	 * 获取一空页
	 */
	public static <E> GenericDefaultPageImpl<E> emptyPage() {
		return (GenericDefaultPageImpl<E>) EMPTY_PAGE;
	}
