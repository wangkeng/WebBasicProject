...
.box {
	filter:progid:DXImageTransform.Microsoft.gradient(startColorstr='#EEEEEE', endColorstr='#EEEEEE'); /*  IE */
	...
	background-image:-ms-linear-gradient(bottom, #EEEEEE 0%, #EEEEEE 100%);
